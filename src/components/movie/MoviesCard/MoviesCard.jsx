...
// const MoviesCard = memo(function MovieCard({ movie, handleMovieSave, savedMoviesList, handleMovieDelete, handleClick, Button, isOwner, place}) {
//   const { image, nameRU, duration, trailerLink } = movie;
//   // console.log('IMAGE',movie.nameRU);
//   const { pathname } = useLocation();
...
//       <div className='movies-card__info'>
//         <div className='movies-card__wrapper'>
//           <h2 className='movies-card__title'>{Math.random()}</h2>
//           {/* {
//             pathname === '/movies' ?
//             <ButtonLike handleClick={handleClick}  isOwner={isOwner}/> :
//             // <ButtonCross handleDelete={handleDelete} place='card'/>
